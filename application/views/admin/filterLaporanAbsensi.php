<div class="container-fluid">
    ...
    <div class="card mx-auto" style="width: 35%">
        <div class="card-header bg-primary text-white text-center">
            Filter Laporan Rekap Absensi Pegawai
        </div>
        ...
        <button style="width: 100%" type="submit" class="btn btn-primary"><i class="fas fa-print"> Cetak Laporan Rekap Absensi</i></button>
