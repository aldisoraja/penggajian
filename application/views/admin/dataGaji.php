<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <form class="form-inline">
            ...
            class="btn btn-success mb-2 ml-2"><i class="fas fa-print"> Cetak Daftar Gaji</i></a>
            <?php }else{ ?>
                <button type="button" class="btn btn-success mb-2 ml-2" data-toggle="modal" data-target="#exampleModal">
                <i class="fas fa-print"> Cetak Daftar Gaji</i></button>
            <?php } ?>
    ...
    <?php $jml_data = count($gaji);
    if($jml_data > 0) { ?>

    <div class="card-body table-responsive">
        <table class="table table-bordered table-striped" id="table6" class="display" width="100%">
            <thead>
                <tr>
                    <th>No</th>
                    <th>NIP</th>
    ...
    <?php }else{ ?>
        <span class="badge badge-danger"><i class="fas fa-info-circle"></i>Data Absensi kosong, Silahkan input
